import { HttpsProxyAgent, HttpsProxyAgentOptions } from 'npm:https-proxy-agent@5.0.1'
import { SocksProxyAgent, SocksProxyAgentOptions } from 'npm:socks-proxy-agent@7.0.0'
